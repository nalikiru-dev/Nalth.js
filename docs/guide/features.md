...
Note you don't need to manually set these up - when you [create an app via `create-nalth`](./), the selected templates would have these pre-configured for you already.
