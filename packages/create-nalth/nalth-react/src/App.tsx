...
function App() {
  ...
  return (
    <div className="min-h-screen bg-[#030308] text-white selection:bg-cyan-500/30">
      ...
      <main className="max-w-[1800px] mx-auto px-6 pt-20 pb-32">
        <div className="text-center mb-20 relative">
          ...
          <p className="max-w-4xl mx-auto text-lg text-slate-400 leading-relaxed font-light mb-12">
      ...
      <footer className="border-t border-white/5 bg-black/20 backdrop-blur-sm">
        <div className="max-w-[1800px] mx-auto px-6 py-12 flex flex-col md:flex-row items-center justify-between gap-8">
