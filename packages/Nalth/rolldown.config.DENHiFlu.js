...
const injected_original_dirname$1 =
  'D:\\Documents\\code\\Nalth.js-main\\packages\\Nalth'
const injected_original_filename$1 =
  'D:\\Documents\\code\\Nalth.js-main\\packages\\Nalth\\rollupLicensePlugin.ts'
const injected_original_import_meta_url$1 =
  'file:///D:/Documents/code/Nalth.js-main/packages/Nalth/rollupLicensePlugin.ts'
...
const injected_original_dirname =
  'D:\\Documents\\code\\Nalth.js-main\\packages\\Nalth'
const injected_original_filename =
  'D:\\Documents\\code\\Nalth.js-main\\packages\\Nalth\\rolldown.config.ts'
const injected_original_import_meta_url =
  'file:///D:/Documents/code/Nalth.js-main/packages/Nalth/rolldown.config.ts'
    ...
    buildEnd(err) {
      ...
      if (!err) {
        for (const file in deps) {
          if (!transformed[file]) {
            this.warn(
              `Optional shim: did not find "${file}" to transform. Continuing...`,
            )
          }
        }
      }
